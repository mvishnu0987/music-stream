        ...
        {playlist.tracks.length === 0 ? (
          ...
          <div className="space-y-1">
            {playlist.tracks.map((track, i) => (
              <div key={`${track.id}-${i}`} className="grid grid-cols-[16px_1fr_40px_40px] md:grid-cols-[16px_1fr_minmax(120px,200px)_40px_40px] lg:grid-cols-[16px_1fr_minmax(120px,200px)_minmax(120px,200px)_40px_40px] gap-4 px-4 py-2 hover:bg-white/5 rounded-md group items-center transition-colors">
